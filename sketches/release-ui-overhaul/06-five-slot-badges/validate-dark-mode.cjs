...
(async()=>{
  await wait(20);
  assert.match(source,/:root\[data-theme="dark"\]\{[\s\S]*--canvas:#000000;[\s\S]*--body-bg:#000000;[\s\S]*--surface:#171a20;[\s\S]*--raised:#232730;[\s\S]*--ink:#f1f3ed;[\s\S]*--tabbar-bg:rgba\(12,14,17,\.76\)/);
