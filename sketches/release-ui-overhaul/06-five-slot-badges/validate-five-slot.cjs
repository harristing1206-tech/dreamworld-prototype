...
(async () => {
  ...
  assert.equal(pauseRecording.textContent.trim(),'Resume','paused recording must expose a visible Resume label');
  ...
  pauseRecording.click();
  assert.equal(pauseRecording.getAttribute('aria-label'),'Pause recording');
  assert.equal(pauseRecording.textContent.trim(),'Pause','resumed recording must restore the visible Pause label');
