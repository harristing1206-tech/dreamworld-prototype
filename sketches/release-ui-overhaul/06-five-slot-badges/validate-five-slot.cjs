...
(async () => {
  ...
  assert.equal(d.getElementById('editDreams').textContent,'Done');
  ...
  dreamRow.querySelector('.swipe-action.edit').click();
  ...
  assert.equal(d.getElementById('editAlarms').textContent,'Done');
